Official Liberating Structures icon assets synced from liberatingstructures.de.

Run `pnpm sync:ls-icons` to refresh the PNG files from the source pages listed in
